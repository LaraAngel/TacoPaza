...
public class BranchController {
    ...
    public List<BranchEntity> getAllBranchesByUser(@RequestParam UserEntity user){return branchService.getAllBranchesByUser(user);}
    ...
    public List<BranchEntity> getAllBranchesByStatus(@RequestParam StatusEntity status){return branchService.getAllBranchesByStatus(status);}
}
